...
import '../wallet/connect_wallet_view.dart';
...
class _AddTransactionScreenState extends State<AddTransactionScreen> {
  ...
  final List<MerchantItem> _merchants = [
    ...
    MerchantItem(
      ...
      defaultCategory: 'Subscriptions',
      logoType: 'asset',
      assetPath: '${ImageAssets.croppedPath}${ImageAssets.logoYoutube}',
    ),
    MerchantItem(
      name: 'Starbucks',
      defaultCategory: 'Food & Dining',
      logoType: 'asset',
      assetPath: '${ImageAssets.croppedPath}${ImageAssets.logoStarbucks}',
    ),
    MerchantItem(
      name: 'PayPal',
      defaultCategory: 'Software',
      logoType: 'asset',
      assetPath: '${ImageAssets.croppedPath}${ImageAssets.logoPaypal}',
    ),
    MerchantItem(
      name: 'Upwork',
      defaultCategory: 'Freelance',
      logoType: 'asset',
      assetPath: '${ImageAssets.croppedPath}${ImageAssets.logoUpwork}',
    ),
    MerchantItem(
      name: 'Other',
