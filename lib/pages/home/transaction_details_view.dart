                  ...
                  children: [
                    ...
                    if (_showTransactionDetails) ...[
                      ...
                      _buildDetailRow('Status', transaction.status.toUpperCase(),
                          valueColor: transaction.status == 'completed' ? const Color(0xFF2F7E79) : AppTheme.warningColor),
                      ...
                      const SizedBox(height: 8),
                      _buildDetailRow('Spending', '${isIncome ? '+' : '-'}${formatter.format(transaction.amount)}',
                          valueColor: amountColor),
                      const SizedBox(height: 8),
                      _buildDetailRow('Fee', formatter.format(calculateFee(transaction.amount))),
                    ],
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          Get.snackbar('Success', 'Receipt downloaded successfully to storage.',
                        ...
                        child: const Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 6),
                            Text('Download Receipt', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                          ],
                        ),
                      ),
                    ),
  ...
  Widget _buildLogo(String title) {
    ...
    if (assetName != null) {
      ...
      return Container(
        ...
        child: Image.asset('assets/cropped/$assetName', fit: BoxFit.contain,
                    ...
                    Flexible(
                      child: Text(
                        ...
                        style: TextStyle(
                          ...
                          color: valueColor ?? (isDark ? AppTheme.darkTextPrimary : const Color(0xFF0F172A)),
                          fontSize: 14,
                        ),
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              ...
              Get.back();
              Get.back();
              Get.snackbar('Deleted', 'Transaction was deleted.',
                  snackPosition: SnackPosition.BOTTOM,
